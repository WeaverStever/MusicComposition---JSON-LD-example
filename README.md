# MusicComposition---JSON-LD-example
A (howto) framework for Schema.org MusicComposition, MusicRecording and release information

A_Day_in_the_Life.txt
Because the song durations are different lengths, the releases were treated as separate recordings.<br>
